...
contract FLPCrowdsale is Ownable {
	...
	function buyByNative() external payable {
		...
		require(ico_token.balanceOf(address(this)) >= amountICOToken, "Insufficient account balance");
	...
	function getICOTokenAmount(address _payment, uint256 _amount) public view returns(bool success,uint256 value) {
